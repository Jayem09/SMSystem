...
type Product struct {
	...
	PointsRequired int  `gorm:"not null;default:0" json:"points_required"` // Points needed to redeem this product (0 = not a reward)
	IsReward       bool `gorm:"not null;default:false" json:"is_reward"`   // Is this a redeemable reward?
